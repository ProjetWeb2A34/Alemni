            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              >
                <ul class="navbar-nav">
                  ...
                  <div class="col-md-3">
                    <a href="showUser.php" class="nav-link">Show</a>
                  </div>
                  ...
                  <li class="dropdown header__nav-item">
                    ...
                    <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuMore">
                      <li><a href="GestionlasseF.php">Gestion Classes </a></li>
                      ...
                      <li><a href="PANIER1.html">Gestion Panier </a></li>
                    </ul>
                  </li>
    ...
    <section class="about_section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <div class="img-box">
              <img src="C:\xampp1\htdocs\ProjetWeb\view\images\about-img.jpg" alt="" />
            </div>
          </div>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="client_container layout_padding">
                <div class="img-box">
                  <img src="C:\xampp1\htdocs\ProjetWeb\view\images\client.png" alt="" />
                </div>
                <div class="detail-box">
                  <h4>Rohali jonson</h4>
                  <h6>customer</h6>
                  ...
                  <img src="C:\xampp1\htdocs\ProjetWeb\view\images\quote.png" alt="" />
                </div>
              </div>
            </div>
            <div class="carousel-item">
        ...
        <div class="info_form">
          <div class="row">
            <div class="offset-lg-3 col-lg-3">
              <h5 class="form_heading">Newsletter</h5>
            </div>
            <div class="col-md-6">
              <form action="#">
...
roleItems.forEach(item => {
  item.addEventListener('click', function() {
    const selectedRole = this.dataset.role; // Get role from data attribute
    window.location.href = `role.php?role=${selectedRole}`; // Redirect with role parameter
  });
});
