...
if(isset($_GET['course_name']) ) {
    ...
    $pdfFiles = [
        'Math' => 'C:\xampp1\htdocs\integration\view\admin\images\Math.pdf',
        'Math2' => 'C:\xampp1\htdocs\integration\view\admin\images\Math2.pdf',
        'English' => 'C:\xampp1\htdocs\integration\view\admin\images\English.pdf',
        'Physique' => 'admin/images/Physique.pdf',
        'French' => 'admin/images/French.pdf',
        'Arabic' => 'admin/images/Arabic.pdf',
        'Coding' => 'admin/images/Coding.pdf'
    ];
