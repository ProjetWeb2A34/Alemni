              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="../assets/img/course1.jpg" class="avatar avatar-sm me-3" alt="course1">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">Introduction to HTML</h6>
                        <p class="text-xs text-secondary mb-0">HTML Master</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0">John Doe</p>
                    <p class="text-xs text-secondary mb-0">john@htmlmaster.com</p>
                  </td>
                  <td class="align-middle text-center text-sm">
                    <span class="text-secondary text-xs font-weight-bold">4 weeks</span>
                  </td>
                  <td class="align-middle text-center text-sm">
                    <span class="badge badge-sm bg-gradient-success">Active</span>
                  </td>
                  <td class="align-middle">
                    <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit course">
                      Edit
                    </a>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="../assets/img/course2.jpg" class="avatar avatar-sm me-3" alt="course2">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">JavaScript Basics</h6>
                        <p class="text-xs text-secondary mb-0">JavaScript Guru</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0">Jane Smith</p>
                    <p class="text-xs text-secondary mb-0">jane@jsbasics.com</p>
                  </td>
                  <td class="align-middle text-center text-sm">
                    <span class="text-secondary text-xs font-weight-bold">6 weeks</span>
                  </td>
                  <td class="align-middle text-center text-sm">
