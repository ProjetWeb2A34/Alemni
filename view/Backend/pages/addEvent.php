...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (
      ...
      $event = new event(
          ...
          $_POST['DATE'],
          $_POST['Participants']
          // No need to pass id_event here
      );
      $eventControlleur->addEvent($event);
...
<body class="g-sidenav-show bg-gray-100">
          ...
          <div class="col-lg-2 col-md-2 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " href="?delete=1&&EVENT_NAME=<?=$currentUser['EVENT_NAME']?>"  role="tab" >
        ...
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <form name="eventForm" onsubmit="return validateForm()" action="addEvent.php" method="post" novalidate>
  ...
  function validateForm() {
    ...
    alert("Event name must be between 3 and 50 characters long");
    return false;
  }
    ...
    // Further validation can be added here (e.g., checking date format)
    return true;
  }
</script> 
    </div>
