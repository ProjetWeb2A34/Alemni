...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-10 mx-42 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-30">
...
<script>
    ...
    var eventsByPriceRangeChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['0-50dt', '51-100dt', 'Supérieur à 100dt'],
            datasets: [{
